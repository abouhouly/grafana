...
import { requireLocalStorageItem } from '../support/localStorage';
...
const isOptionsGroupOpen = (name: string) =>
  !requireLocalStorageItem(`grafana.dashboard.editor.ui.optionGroup[Panel ${name}]`).defaultToClosed;
